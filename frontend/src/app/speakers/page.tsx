        ...
        <div className="absolute bottom-6 right-6 flex flex-col gap-3 translate-x-12 opacity-0 group-hover:translate-x-0 group-hover:opacity-100 transition-all duration-500 delay-100">
          {speaker.linkedin && (
            <a 
              ...
              className="h-10 w-10 rounded-full bg-white/10 backdrop-blur-md flex items-center justify-center text-white hover:bg-[var(--electric)] transition-colors border border-white/10"
          ...
          {speaker.twitter && (
            <a 
              ...
              target="_blank" 
              rel="noopener noreferrer"
              className="h-10 w-10 rounded-full bg-white/10 backdrop-blur-md flex items-center justify-center text-white hover:bg-[#1da1f2] transition-colors border border-white/10"
              onClick={(e) => e.stopPropagation()}
            >
              <Twitter size={18} />
            </a>
          ...
          {speaker.github && (
            <a 
              ...
              target="_blank" 
              rel="noopener noreferrer"
              className="h-10 w-10 rounded-full bg-white/10 backdrop-blur-md flex items-center justify-center text-white hover:bg-[#333] transition-colors border border-white/10"
              onClick={(e) => e.stopPropagation()}
            >
              <Github size={18} />
            </a>
      ...
      <div className="p-8 pb-10 flex-1 flex flex-col">
        ...
        <div className="mt-auto pt-6 border-t border-[var(--border)] flex items-center justify-between">
          ...
          <span className="text-[10px] font-mono font-bold text-[var(--text-3)] uppercase tracking-tighter group-hover:text-[var(--text-1)] transition-colors">
            View Profile <ArrowUpRight size={12} className="inline ml-1" />
          </span>
        </div>
      </div>
    </motion.div>
