...
const TShirtSelector = ({
  ...
  return (
    <div className="flex flex-col gap-3">
      <span className="text-sm font-medium text-[var(--text-2)]">T-Shirt Size</span>
        ...
        <div className="relative hidden flex-col justify-center overflow-hidden bg-[var(--surface)] p-12 lg:flex">
          ...
          <div className="relative z-10 h-full flex flex-col">
            ...
            <motion.div
              ...
              className="my-auto"
            >
              <Badge variant="outline" className="mb-4 uppercase tracking-[0.2em] text-[var(--electric-light)] underline decoration-[var(--electric)]/20 underline-offset-4">The Cloud Summit</Badge>
              ...
              <div className="mt-16 rounded-[var(--radius-lg)] border border-[var(--border)] bg-[var(--panel)]/50 p-6 backdrop-blur-md shadow-elevated">
                <p className="italic text-[var(--text-2)] leading-relaxed">
                  ...
                  If you're a student building literally anything, you have to be here."
                </p>
                <div className="mt-4 flex items-center gap-4">
                  ...
                  <div>
                    <span className="block text-sm font-bold text-[var(--text-1)]">Alex Rivera</span>
                    <span className="block text-xs text-[var(--text-3)] text-mono">Cloud Engineer @ AWS Cloud Club</span>
                  </div>
                </div>
              </div>
            </motion.div>
              ...
              {!isSuccess ? (
                ...
                >
                  ...
                  <form onSubmit={handleSubmit(onSubmit)} className="space-y-6">
                    ...
                    <TShirtSelector
                      value={selectedSize || ""}
                      onChange={(size) => setValue("tShirtSize", size as any, { shouldValidate: true })}
                    ...
                    <p className="mt-6 text-center text-[10px] uppercase tracking-widest text-[var(--text-3)] font-mono">
                      By registering, you agree to our Code of Conduct & Privacy Policy
                    </p>
                  </form>
                </motion.div>
              ) : (
                ...
                >
                  ...
                  <h2 className="font-display text-4xl font-extrabold text-[var(--text-1)]">You're In!</h2>
